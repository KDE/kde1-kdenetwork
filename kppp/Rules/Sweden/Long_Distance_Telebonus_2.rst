##############################################################################
# Swedish rate ruleset for long distance calls /w Telebonus 2 (15% discount) #
...
name=Swedish_Long_Distance_Telebonus_2
currency_symbol=SEK
...
# Låg taxa: 21,25 öre/min (räknat per sekund)
default=(0.010625, 3)

# Hög taxa: 42,5 öre/min måndag-fredag 8-18
on (monday..friday) between (8:00..17:59) use (0.02125, 3)

# Röda helgdagar (de som infaller på en lördag/söndag utelämnade)
# nyårsdagen
on (01/01) between () use (0.010625, 3)
# trettondag jul
on (01/06) between () use (0.010625, 3)
# långfredagen
on (easter-2) between () use (0.010625, 3)
# annandag påsk
on (easter+1) between () use (0.010625, 3)
# första maj
on (05/01) between () use (0.010625, 3)
# kristi himmelfärds dag
on (easter+39) between () use (0.010625, 3)
# annandag pingst
on (easter+50) between () use (0.010625, 3)
# juldagen
on (12/25) between () use (0.010625, 3)
# annandag jul
on (12/26) between () use (0.010625, 3)

# "aftnar" (osäkert om följande är korrekt & fullständigt)
# trettondagsafton
on (01/05) between () use (0.010625, 3)
# julafton
on (12/24) between () use (0.010625, 3)
# nyårsafton
on (12/31) between () use (0.010625, 3)
