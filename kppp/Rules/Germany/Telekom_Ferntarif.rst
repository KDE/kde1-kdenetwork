...
on (monday..friday)   between (5:00..9:00)   use (0.12,  21.5)
on (monday..friday)   between (9:00..12:00)  use (0.12,  12)
on (monday..friday)   between (12:00..18:00) use (0.12,  13.5)
on (monday..friday)   between (18:00..21:00) use (0.12,  21.5)
on (monday..friday)   between (21:00..2:00)  use (0.12,  30)
on (saturday..sunday) between (5:00..21:00)  use (0.12,  21.5)
on (saturday..sunday) between (21:00..5:00)  use (0.12,  30)
