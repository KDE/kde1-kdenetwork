...
# service package !
#
# *** for non-City calls within a range of 50 km *** - Use at your own risk.
#
...
on (monday..friday)   between (18:00..8:00)  use (0.011, 6)
on (saturday..sunday) between (00:00..23:59) use (0.011, 6)

# Spezialtarif an bundeseinheitlichen Feiertagen
# Feiertagstarif = Wochenendtarif

on (01/01, easter-2, easter, easter+1, 05/01, easter+39, easter+49, easter+50, 10/03, 12/25, 12/26) between (00:00..23:59) use (0.011, 6)
...
on (easter-48, easter-52) between (00:00..23:59) use (0.011, 6)
