	...
	Inherited( parent, name, 45056 )
{
	...
	ComboB_ServerName = new QComboBox( TRUE, this, "ComboBox_1" );
	...
	ComboB_ServerName->setInsertionPolicy( QComboBox::AtTop );
	ComboB_ServerName->setSizeLimit( 10 );
	ComboB_ServerName->setAutoResize( FALSE );
